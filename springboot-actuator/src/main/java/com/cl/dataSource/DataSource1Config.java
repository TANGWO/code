...
@MapperScan(basePackages = "com.cl.source01.mapper", sqlSessionFactoryRef = "source1SqlSessionFactory")
public class DataSource1Config {
	...
	@Primary
	public SqlSessionFactory sourceSqlSessionFactory(@Qualifier("source1DataSource") DataSource dataSource)
			throws Exception {
	...
	public SqlSessionTemplate sourceSqlSessionTemplate(
			@Qualifier("source1SqlSessionFactory") SqlSessionFactory sqlSessionFactory) throws Exception {

     ...
     <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
               <ul class="menu weui-t_c weui-mt10">
                   <li><a href="noticeOne" class="on">通知公告</a></li>
          ...
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 ">
               <h4 class="clearfix weui-bb">
                   <span class="weui-fl titlespan">通知公告</span>
                   <span class="weui-fr weui-c_9 weui-pt15">当前位置：网站首页>通知公告</span>
               </h4>
               <ul class="weui-f16 newsul"  id="notice">
               </ul>
               <div class="page weui-pt30 weui-pb30 weui-t_c weui-f20 " style="display: inline-block; vertical-align: middle;">

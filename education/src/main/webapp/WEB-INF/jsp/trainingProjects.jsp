	 ...
	 $.ajax({
		   ...
		   success: function(msg){
			   ...
			   if(info){
			     ...
			     $("#trainingProjects").empty();
		     	 $("#trainingProjects").append(infos);
		     	 $("#pageLine").empty();
     ...
     <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
               <ul class="menu weui-t_c weui-mt10">
                   ...
                   <li><a href="trainingProjects" class="on">培训项目</a></li>
          ...
          <div class="col-lg-9 col-md-9 col-sm-9  col-xs-9 weui-lh30">
               <h4 class="clearfix weui-bb">
                   <span class="weui-fl titlespan">培训项目</span>
                   <span class="weui-fr weui-c_9 weui-pt15">当前位置：网站首页>培训项目</span>
               </h4>
               <ul class="weui-f16 newsul" id="trainingProjects">
               </ul>

...
<script type="text/javascript">
	 ...
	 $.ajax({
		   ...
		   success: function(msg){
			   ...
			   if(info){
			     ...
			     $("#dynamicsInformation").empty();
		     	 $("#dynamicsInformation").append(infos);
		     	 $("#pageLine").empty();
 ...
 function getInfoByPage(v){
	 $.ajax({
		   ...
		   success: function(msg){   var info = JSON.parse(msg);
		   //console.log(info['context']);
		   if(info){
		     var context=info['context'];
		     var contexts = JSON.parse(context);
     ...
     <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
               <ul class="menu weui-t_c weui-mt10">
                   ...
                   <li><a href="dynamicsInformation" class="on">资讯动态</a></li>
          ...
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 weui-lh30">
               <h4 class="clearfix weui-bb">
                   <span class="weui-fl titlespan">资讯管理</span>
                   <span class="weui-fr weui-c_9 weui-pt15">当前位置：网站首页>资讯管理</span>
               </h4>
               <ul class="weui-f16 newsul" id="dynamicsInformation">

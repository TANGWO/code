...
<div class="top">
     <div class="container">
          <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 weui-t_r">${user.realName}   <a href="logout">退出</a></div>
           </div>
     </div>
</div>
     ...
     <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 weui-pt20">
               <ul class="menu weui-t_c">
                   <li><a href="myCourse" class="on">我的课程</a></li>
                   <li><a href="historyCourse">历史课程</a></li>
               </ul>
          ...
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 weui-f16" id="mycourse">

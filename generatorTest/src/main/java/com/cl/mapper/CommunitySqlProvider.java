...
import com.cl.entity.CommunityExample.Criteria;
import com.cl.entity.CommunityExample.Criterion;
...
public class CommunitySqlProvider {
    ...
    protected void applyWhere(CommunityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
